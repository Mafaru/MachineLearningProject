...
\author{Mario Morra 2156770, Leonardo Sereni}
\date{}
...
\section{Implementation of the Tabular Q-Learning
Agent}\label{implementation-of-the-tabular-q-learning-agent}}
...
\subsection{\texorpdfstring{Action Selection: \(\epsilon\)-Greedy
Policy}{Action Selection: \textbackslash epsilon-Greedy Policy}}\label{action-selection-epsilon-greedy-policy}}
...
Visualization}\label{evaluation-and-visualization}}
...
Analysis}\label{experimental-results-and-analysis}}
...
\subsection{Interpretation of the Learned
Policy}\label{interpretation-of-the-learned-policy}}
