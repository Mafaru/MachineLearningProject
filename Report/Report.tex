...
\hypertarget{From Theory to implementation DQN}{%
\section{From Theory to implementation}\label{From Theory to implementation}}
...
The function evaluate\_agent, plot\_training\_results and run\_demo are the same of Tabular agent, so are not reported.
